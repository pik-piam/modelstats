...
This is an introduction to the Testing Suite for big models developed at PIK RD3. For big models no standard continuous integration (CI) techniques can be deployed, and unit tests are not easy to apply and do not provide tests for the complete model workflow. We therefore developed a custom Testing Suite.
