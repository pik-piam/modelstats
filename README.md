...
R package **modelstats**, version **0.15.8**
...
Giannousakis A, Richters O (2023). _modelstats: Run Analysis Tools_. R package version 0.15.8, <URL: https://github.com/pik-piam/modelstats>.
