...
R package **modelstats**, version **0.11.6**
...
Giannousakis A (2023). _modelstats: Run Analysis Tools_. R package version 0.11.6, <URL: https://github.com/pik-piam/modelstats>.
