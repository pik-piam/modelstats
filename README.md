...
R package **modelstats**, version **0.15.9**
...
Giannousakis A, Richters O (2023). _modelstats: Run Analysis Tools_. R package version 0.15.9, <URL: https://github.com/pik-piam/modelstats>.
