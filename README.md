...
R package **modelstats**, version **0.0.1.9034**
...
Giannousakis A (2021). _modelstats: Run Analysis Tools_. R package version 0.0.1.9034, <URL: https://github.com/pik-piam/modelstats>.
...
@Manual{,
  ...
  year = {2021},
  note = {R package version 0.0.1.9034},
