...
R package **modelstats**, version **0.13.0**
...
Giannousakis A (2023). _modelstats: Run Analysis Tools_. R package version 0.13.0, <URL: https://github.com/pik-piam/modelstats>.
