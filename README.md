...
R package **modelstats**, version **0.21.19**
...
Giannousakis A, Richters O (2024). _modelstats: Run Analysis Tools_. R package version 0.21.19, <https://github.com/pik-piam/modelstats>.
...
@Manual{,
  ...
  year = {2024},
  note = {R package version 0.21.19},
