...
R package **modelstats**, version **0.14.8**
...
Giannousakis A (2023). _modelstats: Run Analysis Tools_. R package version 0.14.8, <URL: https://github.com/pik-piam/modelstats>.
