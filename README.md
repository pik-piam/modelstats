...
R package **modelstats**, version **0.11.5**
...
Giannousakis A (2023). _modelstats: Run Analysis Tools_. R package version 0.11.5, <URL: https://github.com/pik-piam/modelstats>.
