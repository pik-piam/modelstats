...
R package **modelstats**, version **0.27.11**
...
Giannousakis A, Richters O (2025). "modelstats: Run Analysis Tools." Version: 0.27.11, <https://github.com/pik-piam/modelstats>.
