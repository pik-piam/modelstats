...
R package **modelstats**, version **0.14.14**
...
Giannousakis A (2023). _modelstats: Run Analysis Tools_. R package version 0.14.14, <URL: https://github.com/pik-piam/modelstats>.
...
@Manual{,
  ...
  year = {2023},
  note = {R package version 0.14.14},
