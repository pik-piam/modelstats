...
R package **modelstats**, version **0.0.1.9003**
...
Giannousakis A (2021). _modelstats: Run Analysis Tools_. R package version 0.0.1.9003, <URL: https://github.com/pik-piam/modelstats>.
