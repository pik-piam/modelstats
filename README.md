...
R package **modelstats**, version **0.20.2**
...
Giannousakis A, Richters O (2024). _modelstats: Run Analysis Tools_. R package version 0.20.2, <https://github.com/pik-piam/modelstats>.
