...
R package **modelstats**, version **0.21.4**
...
Giannousakis A, Richters O (2024). _modelstats: Run Analysis Tools_. R package version 0.21.4, <URL: https://github.com/pik-piam/modelstats>.
