...
R package **modelstats**, version **0.14.9**
...
Giannousakis A (2023). _modelstats: Run Analysis Tools_. R package version 0.14.9, <URL: https://github.com/pik-piam/modelstats>.
