...
R package **modelstats**, version **0.15.4**
...
Giannousakis A (2023). _modelstats: Run Analysis Tools_. R package version 0.15.4, <URL: https://github.com/pik-piam/modelstats>.
